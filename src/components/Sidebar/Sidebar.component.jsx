...
const onClick = () => setShowText(true);
 ...
 <Ultrasidebar/>
      ...
      <style>{css}</style>
      <h3 style={{"marginTop":"-20px","marginLeft":"-20px","fontFamily":"comic sans ms"}}>   
        <span>
      ...
      <h6>
        <Dropdown>
          ...
          <Dropdown.Toggle variant="success" id="dropdown-basic" style={{"backgroundColor":"lightblue"}}>user
          </Dropdown.Toggle>
      ...
      {friends.map((value, key) => {
            return (
              <div className="chatbut">
                <button className="btn btn-secondary" style={{"fontFamily":"monospace","paddingLeft":"15px"}}
                onClick={()=>{set(value[0],value[1].imgUrl);}} >
                <span>
                  <img src={value[1].imgUrl} alt="" width={"50px"} style={{"borderRadius":"50%", "height":"50px","objectFit":"cover","marginRight":"12px"}}/>
                </span>
                {value[0]}      
              </button><br />
              </div>
